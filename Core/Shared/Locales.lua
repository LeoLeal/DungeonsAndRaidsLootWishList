...
local translations = {
  ...
  deDE = {
    ...
    TAG_DELETE_CONFIRMATION_TITLE = "Bist du sicher, dass du fortfahren mochtest?",
    TAG_DELETE_CONFIRMATION = "Diese Gegenstande werden aus der Wunschliste entfernt, wenn du diesen Tag loschst.",
    TAG_DELETE_AFFECTED_ITEMS = "Betroffene Gegenstande",
  ...
  esES = {
    ...
    TAG_DELETE_CONFIRMATION = "Estos objetos se eliminaran de la lista de deseos si borras esta etiqueta.",
  ...
  frFR = {
    ...
    REMOVE = "Supprimer",
    CREATE = "Creer",
    CREATE_NEW_TAG = "Creer une nouvelle etiquette",
    OTHER = "Autre",
    LOOT_SOURCE = "Source",
    EQUIPMENT_SLOT = "Slot",
    DEFAULT_WISHLIST_TAG = "Meilleur de l'emplacement",
    WISHLIST_TAGS = "Sélectionnez les étiquettes de cet objet",
    TAG_FILTER = "Filtrer les etiquettes",
    TAG_DELETE_CONFIRMATION_TITLE = "Voulez-vous vraiment continuer ?",
    TAG_DELETE_CONFIRMATION = "Ces objets seront retires de la liste de souhaits si vous supprimez cette etiquette.",
    TAG_DELETE_AFFECTED_ITEMS = "Objets concernes",
  ...
  ptBR = {
    ...
    TAG_DELETE_CONFIRMATION = "Esses itens serao removidos da lista de desejos se voce excluir esta etiqueta.",
